...
namespace fay
{
	...
	*/
	...
	enum class InstType
	{
		...
		GreaterObject = 857,
		GreaterFunction = 858,
		GreaterEqualVoid = 865,
		GreaterEqualBool = 866,
		GreaterEqualByte = 867,
		GreaterEqualInt = 868,
		GreaterEqualLong = 869,
		GreaterEqualFloat = 870,
		GreaterEqualDouble = 871,
		GreaterEqualString = 872,
		GreaterEqualObject = 873,
		GreaterEqualFunction = 874,
		LessVoid = 881,
		LessBool = 882,
		LessByte = 883,
		LessInt = 884,
